 ...
 */
public class McBasePageWrapper<T extends McBaseResponse> implements Serializable {
  ...
  public McBasePageWrapper(Page<T> page, String url) {
    this.page = page;
    this.url = url;
